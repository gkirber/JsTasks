...
// }
//
// // Функція для додавання унікального числа в масив
// function addUniqueNumber(numbersArray, min, max) {
//     let newNumber
//
//     // Генеруємо число, поки воно не буде унікальним
//     do {
//         newNumber = generateRandomNumber(min, max)
//     } while (numbersArray.includes(newNumber))
//
//     numbersArray.push(newNumber) // Додаємо унікальне число в масив
//     return numbersArray
// }
//
// // Викликаємо функцію та оновлюємо масив
// addUniqueNumber(myNumbers, MIN, MAX)
//
// console.log(myNumbers) // Bиводимо оновлений масив